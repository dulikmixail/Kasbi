<%@ Page Language="vb" AutoEventWireup="false" Inherits="Kasbi.Reports.RepairRequest" Culture="ru-RU" CodeFile="RepairRequest.aspx.vb" %>
				...
				<TR>
					<TD>
						<TABLE id="Table2" width="100%">
							...
							<TR>
								<TD class="SectionRowLabel" vAlign="top">Детали :</TD>
								<TD class="SectionRow">
									<asp:textbox id="tbxDetails" runat="server" Width="250px" BackColor="#F6F8FC" BorderWidth="1px"></asp:textbox> <input name="repbydetail" type="Checkbox" /> Вывести отчёт по деталям</TD>
							</TR>
							<TR>
								<TD class="SectionRowLabel" vAlign="top">Неисправность :</TD>
								<TD class="SectionRow">
									<asp:textbox id="tbxDisrepair" runat="server" Width="250px" BackColor="#F6F8FC" BorderWidth="1px"></asp:textbox></TD>
							</TR>
							<TR>
