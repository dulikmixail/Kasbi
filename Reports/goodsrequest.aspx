<%@ Page Language="vb" AutoEventWireup="false" Inherits="Kasbi.Reports.GoodsRequest" CodeFile="GoodsRequest.aspx.vb" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
							...
							<TABLE id="Table2" width="100%">
								...
								<TR>
									...
									<TD class="SectionRow" valign="top">
										<asp:radiobutton id="Radiobutton1" runat="server" CssClass="text02" Checked="True" GroupName="rbtnProviderSet"
											Text="По всем"></asp:radiobutton>&nbsp;&nbsp;
										<asp:radiobutton id="Radiobutton2" runat="server" CssClass="text02" GroupName="rbtnProviderSet" Text="По списку"></asp:radiobutton>
									</TD>
								</TR>
								<TR>
									<TD class="SectionRowLabel" width="20">Поставщики:
									</TD>
									<TD class="SectionRow">
										<asp:listbox id="lbxProviders" runat="server" BackColor="#F6F8FC" SelectionMode="Multiple" Rows="10"></asp:listbox>
									</TD>
								</TR>
							</TABLE>
						</TD>
			...
			<asp:validationsummary id="Validationsummary2" runat="server" HeaderText="Заполните обязательные поля :"
				ShowSummary="False" ShowMessageBox="True" CssClass="ErrorMessage"></asp:validationsummary>
		</form>
	</body>
</HTML>
