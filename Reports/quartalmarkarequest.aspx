<%@ Page Language="vb" AutoEventWireup="false" Inherits="Kasbi.Reports.QuartalMarkaRequest" CodeFile="QuartalMarkaRequest.aspx.vb" %>
<%@ Register TagPrefix="uc1" TagName="Footer" Src="../Controls/Footer.ascx" %>
<%@ Register TagPrefix="uc1" TagName="Header" Src="../Controls/Header.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<head  runat ="server">
	<title >[Отчет по использованию средств контроля]</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<table class="PageTitle" cellSpacing="1" cellPadding="2" width="100%" border="0">
				<tr>
					<td class="HeaderTitle" width="100%">&nbsp;Отчеты&nbsp;-&gt; Отчет по 
						использованным средствам контроля</td>
				</tr>
			</table>
				...
				<TR>
					<TD>
						<TABLE id="Table2" width="100%">
							...
							<TR>
								<TD width="20"></TD>
								<TD class="SectionRow"><asp:checkbox id="chkDismissalMark" runat="server" CssClass="text02" Text="Снятые средства контроля"
