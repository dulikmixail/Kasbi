<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AdvertisingRequest.aspx.vb" Inherits="Kasbi.Reports.AdvertisingRequest" %>
...
<HTML>
	<HEAD>
		<title>УП Рамок - Отчет по рекламе</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<table class="PageTitle" cellSpacing="1" cellPadding="2" width="100%" border="0">
				<tr>
					<td class="HeaderTitle" width="100%">&nbsp;Отчеты&nbsp;-&gt; Отчет по рекламе</td>
				</tr>
			</table>
