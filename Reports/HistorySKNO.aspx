                    ...
                    <table id="Table2" width="100%">
                        ...
                        <tr>
                            <td class="SectionRowLabel" style="WIDTH: 127px">
                                <asp:label id="Label1" runat="server">Начальная дата:</asp:label>
                            </td>
                            <td class="SectionRow">
                                ...
                                <asp:comparevalidator id="typeValidator" runat="server" CssClass="ErrorMessage" ControlToValidate="tbxBeginDate"
                                                      Operator="DataTypeCheck" Type="Date" Display="Dynamic" EnableClientScript="False">
                                    Пожалуйста, введите корректные значение начальной даты
                                </asp:comparevalidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="SectionRowLabel" style="WIDTH: 127px">
                                <asp:label id="Label3" runat="server">Конечная дата:</asp:label>
                            </td>
                            <td class="SectionRow">
                                ...
                                <asp:comparevalidator id="CompareValidator1" runat="server" CssClass="ErrorMessage" ControlToValidate="tbxEndDate"
                                                      Operator="DataTypeCheck" Type="Date" Display="Dynamic" EnableClientScript="False">
                                    Пожалуйста, введите корректные значение конечной даты
                                </asp:comparevalidator>
                            </td>
                        </tr>
                        </tbody>
        ...
        <tr>
            <td>
                <table>
                    ...
                    <tr>
                        <td class="SectionRowLabel" style="width: 127px">
                            <asp:label runat="server">Сотрудники:</asp:label>
                        </td>
                        <td>
                            <asp:ListBox runat="server" ID="lstEmployee" Rows="20" Width="300px" AutoPostBack="True"/>
                        </td>
                    </tr>
                    </tbody>
                </table>
