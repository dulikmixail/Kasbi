			...
			<table width="100%" border="0" cellpadding="2" cellspacing="1">
				...
				<tr>
					<td class="SectionRow">
						...
						<asp:Image runat="server" ID="Image0" ImageUrl="../Images/sel.gif" style="Z-INDEX: 103; position:relative; left:10px;"></asp:Image>&nbsp;Продажи</asp:hyperlink></td>
				</tr>
				<tr>
					<td class="SectionRow" style="font-size:12px">
						...
						<asp:Image runat="server" ID="Image2" ImageUrl="../Images/sel.gif" style="Z-INDEX: 103; position:relative; left:10px;"></asp:Image>&nbsp;Ремонт</asp:HyperLink>
					</td>				
				</tr>
				<tr>
					<td class="SectionRow">
						<asp:HyperLink id="lnkDetailsReports" runat="server" NavigateUrl="DetailRequest.aspx" CssClass="PanelHider">
						<asp:Image runat="server" ID="Image15" ImageUrl="../Images/sel.gif" style="Z-INDEX: 103; position:relative; left:10px;"></asp:Image>&nbsp;Детали</asp:HyperLink></td>
				</tr>				
				<tr>
					<td class="SectionRow">
						<asp:HyperLink id="lnkDealerReports" runat="server" NavigateUrl="DealersRequest.aspx" CssClass="PanelHider">
						<asp:Image runat="server" ID="Image3" ImageUrl="../Images/sel.gif" style="Z-INDEX: 103; position:relative; left:10px;"></asp:Image>&nbsp;Дилеры - долги</asp:HyperLink></td>
				</tr>
				<tr>
					<td class="SectionRow">
						<asp:HyperLink id="HyperLink1" runat="server" NavigateUrl="ClientReports.aspx" CssClass="PanelHider">
						<asp:Image runat="server" ID="Image20" ImageUrl="../Images/sel.gif" style="Z-INDEX: 103; position:relative; left:10px;"></asp:Image>&nbsp;Клиенты - долги</asp:HyperLink></td>
				</tr>	
			    <tr>
			        <td class="SectionRow">
			    ...
			    <tr>
			        <td class="SectionRow">
			            <asp:HyperLink id="lnkExecutorTOReports" runat="server" NavigateUrl="ExecutorTORequest.aspx" CssClass="PanelHider">
			                <asp:Image runat="server" ID="Image1" ImageUrl="../Images/sel.gif" style="Z-INDEX: 103; position:relative; left:10px;"></asp:Image>&nbsp;Реестр&nbsp;за&nbsp;ТО&nbsp;по&nbsp;ответственному&nbsp;мастеру&nbsp;</asp:HyperLink></td>
			    </tr>

				<tr>
					<td class="SectionRow">
						<asp:HyperLink id="lnkMasterTOReports" runat="server" NavigateUrl="MasterTORequest.aspx" CssClass="PanelHider">
						<asp:Image runat="server" ID="Image5" ImageUrl="../Images/sel.gif" style="Z-INDEX: 103; position:relative; left:10px;"></asp:Image>&nbsp;ТО&nbsp;по&nbsp;мастерам</asp:HyperLink></td>
				</tr>
				<!--
				<tr>
					<td class="SectionRow">
				...
				<tr>
					<td class="SectionRow">
						...
						<asp:Image runat="server" ID="Image4" ImageUrl="../Images/sel.gif" style="Z-INDEX: 103; position:relative; left:10px;"></asp:Image>&nbsp;Квартальный отчет об использованных средствах контроля</asp:HyperLink></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="SectionRow">
						...
						<asp:Image runat="server" ID="Image9" ImageUrl="../Images/sel.gif" style="Z-INDEX: 103; position:relative; left:10px;"></asp:Image>&nbsp;Оборотная ведомость</asp:HyperLink></td>
				</tr>
			</table>
