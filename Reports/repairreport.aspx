...
<tr>
    ...
    <td align="left" width="20">
        <asp:label id="lblStartDate" Font-Size="9" Runat="server"></asp:label>
    </td>
    <td></td>
    <td width="20"></td>
</tr>
<tr>
    ...
    <td align="left" width="20">
        <asp:label id="lblEndDate" Font-Size="9" Runat="server"></asp:label>
    </td>
    <td align="right">
        <asp:label id="lblPrintDate" Font-Size="9" Runat="server"></asp:label>
    </td>
    <td width="20"></td>
</tr>
<tr>
    ...
    <Columns>
        ...
        <asp:TemplateColumn HeaderText="Снятые СК">
            ...
            <ItemTemplate>
                <%#
                IIf(
                    DataBinder.Eval(Container.DataItem, "marka_cto_in") <>
                    DataBinder.Eval(Container.DataItem, "marka_cto_out"),
                    DataBinder.Eval(Container.DataItem, "marka_cto_in"), "")%>
                &nbsp;
                <%#
                ...
                <%#
                IIf(
                    DataBinder.Eval(Container.DataItem, "marka_reestr_in") <>
                    DataBinder.Eval(Container.DataItem, "marka_reestr_out"),
                    DataBinder.Eval(Container.DataItem, "marka_reestr_in"), "")%>
                &nbsp;
                <%#
                IIf(
                    DataBinder.Eval(Container.DataItem, "marka_pzu_in") <>
                    DataBinder.Eval(Container.DataItem, "marka_pzu_out"),
                    DataBinder.Eval(Container.DataItem, "marka_pzu_in"), "")%>
                &nbsp;
                <%#
                IIf(
                    DataBinder.Eval(Container.DataItem, "marka_mfp_in") <>
                    DataBinder.Eval(Container.DataItem, "marka_mfp_out"),
                    DataBinder.Eval(Container.DataItem, "marka_mfp_in"), "")%>
                &nbsp;
                <%#
        ...
        <asp:TemplateColumn HeaderText="Гарантийный&lt;BR&gt;срок">
            <ItemStyle HorizontalAlign="Center"></ItemStyle>
            <ItemTemplate>
                <asp:Label ID="lblGarantia" runat="server"></asp:Label>
                <asp:Label ID="lblGarantia2" runat="server" ForeColor="Red"></asp:Label>
