...
<form id="frmNewRequest" method="post" runat="server">
    ...
    <TABLE cellSpacing="0" cellPadding="0" width="100%">
        <TR class="DetailField">
            <TD class="SectionRow" width="60">
                <b>&nbsp;Клиент&nbsp;<asp:label id="custUID" runat="server"></asp:label>:&nbsp;</b>
            </TD>
            <td class="SectionRow" width="1000">
                <asp:label id="lblCustomerInfo" runat="server" CssClass="itemGrid"></asp:label>
            </td>
            <td class="SectionRow" align="right">
                <asp:hyperlink id="lnkAddSale" runat="server" EnableViewState="False" CssClass="PanelHider">Добавить&nbsp;заказ</asp:hyperlink><br>
                <!--	<br>
        ...
        <TR>
            <TD colSpan="3">
                <asp:label id="msgClientInfo" runat="server" Font-Bold="true" ForeColor="#ff0000" EnableViewState="false"
                           CssClass="PanelHider">
                </asp:label>
            </TD>
        </TR>
        ...
        <TR class="DetailField">
            <TD class="SectionRow" colSpan="3">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton ID="lnkDogovorTo7" runat="server" Target="_blank">Договор&nbsp;ТО-7</asp:LinkButton>
            </TD>
        </TR>
        <TR class="DetailField">
            <TD colSpan="3">
        ...
        <TR>
            <TD align="center" colSpan="3">
                <asp:panel id="pnlSales" runat="server" EnableViewState="false"></asp:panel>
            </TD>
        </TR>
    </TABLE>
