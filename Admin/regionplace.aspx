...
<%@ Page Language="vb" AutoEventWireup="false" Inherits="Kasbi.Admin.RegionPlace" CodeFile="RegionPlace.aspx.vb" %>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<table class="PageTitle" cellSpacing="1" cellPadding="2" width="100%" border="0">
				<tr>
					<td class="HeaderTitle" width="100%">&nbsp;Администрирование -&gt; Районы установки 
						ККМ</td>
				</tr>
				<tr>
					<td height="10">
						<asp:label id="msgError" runat="server" Font-Bold="True" ForeColor="Red" EnableViewState="False"></asp:label></td>
				</tr>
				<tr>
					<td align="center">
						<asp:datagrid id="grdRegionPlace" runat="server" ShowFooter="True" AutoGenerateColumns="False"
							Width="75%" PageSize="100" AllowPaging="True" BorderColor="#CC9966"
							BorderWidth="1px">
                        ...
                        <FooterStyle CssClass="footerGrid"></FooterStyle>
							<Columns>
								<asp:TemplateColumn HeaderText="Наименование">
									...
									<FooterTemplate>
										<asp:TextBox id="txtRegionPlaceName" runat="server" BorderWidth="1px" BackColor="#F6F8FC" Width="450px"></asp:TextBox>
									</FooterTemplate>
									<EditItemTemplate>
										<asp:TextBox id=txtRegionPlaceUpdateName runat="server" BorderWidth="1px" BackColor="#F6F8FC" Width="450px" Text='<%# DataBinder.Eval(Container, "DataItem.name") %>'>
										</asp:TextBox>
									</EditItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn>
						<FooterStyle HorizontalAlign="Center" Width="30"></FooterStyle>
                                ...
                                <EditItemTemplate>
									...
									<FooterTemplate>
										&nbsp;&nbsp;
										<asp:LinkButton id="btnAddRegionPlace" runat="server" Font-Size="8pt" CommandName="AddRegionPlace">Добавить</asp:LinkButton>
									</FooterTemplate>
								</asp:TemplateColumn>
							</Columns>
