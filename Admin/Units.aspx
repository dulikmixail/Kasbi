<%@ Page Language="vb" AutoEventWireup="false" Inherits="Kasbi.Admin.Units" CodeFile="Units.aspx.vb" %>
        ...
        <table class="PageTitle" cellspacing="1" cellpadding="2" width="100%" border="0">
            <tr>
                <td class="HeaderTitle" width="100%">
                    &nbsp;Администрирование -&gt; Единицы&nbsp;измерения</td>
            </tr>
            <tr>
                <td height="10">
            ...
            <tr>
                <td align="center">
                    <asp:DataGrid ID="grdUnits" runat="server" ShowFooter="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateColumn HeaderText="Наименование">
                                <ItemTemplate>
                                    <%#DataBinder.Eval(Container, "DataItem.UnitDesciption")%>
                                </ItemTemplate>
                                <FooterTemplate>
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtNameEdit" runat="server" BorderWidth="1px" BackColor="#F6F8FC"
                                        Text='<%# DataBinder.Eval(Container, "DataItem.UnitDesciption") %>'>
                                    </asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="Сокращение">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container, "DataItem.UnitShortDesciption") %>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txtShortName" runat="server" BorderWidth="1px" BackColor="#F6F8FC"></asp:TextBox>
                                </FooterTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtShortNameEdit" runat="server" BorderWidth="1px" BackColor="#F6F8FC"
                                        Text='<%# DataBinder.Eval(Container, "DataItem.UnitShortDesciption") %>'>
                                    </asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn>
