            ...
            <tr class="Unit">
                ...
                <td class="Unit" align="right">
                    <asp:HyperLink ID="btnNew" runat="server" EnableViewState="False" CssClass="PanelHider"
                        NavigateUrl="NewGood.aspx">Новый&nbsp;ККМ</asp:HyperLink></td>
            </tr>
            <tr>
                <td colspan="2">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtFindGoodSetPlace" runat="server" BorderWidth="1px" Height="18px"
                                    MaxLength="50" Width="280px"></asp:TextBox></td>
                        </tr>
                    </table>
                </td>
            </tr>
                ...
                <td colspan="2">
                    <asp:LinkButton ID="btnFilter" runat="server" CssClass="PanelHider">
                        <asp:Image runat="server" ID="imgSelFilter" ImageUrl="Images/sel.gif" Style="z-index: 103;
                            position: relative; left: 10;"></asp:Image>&nbsp;Фильтр</asp:LinkButton><asp:Label
                                ID="lblFilterCaption" runat="server" Font-Size="8pt"></asp:Label></td>
            </tr>
            <tr class="SectionRow">
                                    ...
                                    <table style="font-size: 8pt; font-family: Verdana" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td style="color: #990000">
                                                Использовать дату для выбора касс по</td>
                                        </tr>
                                    </table>
                                    <br>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn SortExpression="num_cashregister" HeaderText="№">
                                ...
                                <EditItemTemplate>
                                    <p class="SubTitleEditbox">
                                        Заводской номер:</p>
                                    <asp:TextBox ID="txtedtNum" runat="server" BorderWidth="1px" Width="100%" Text='<%# DataBinder.Eval(Container, "DataItem.num_cashregister") %>'
                                        BorderStyle="Solid">
                                    </asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn SortExpression="num_control_reestr" HeaderText="№ СК изг.">
                                <HeaderStyle Font-Underline="True"></HeaderStyle>
                                <ItemTemplate>
                                    <asp:Label ID="lbledtControl" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.num_control_reestr") & "<br>" & DataBinder.Eval(Container, "DataItem.num_control_pzu") & "<br>" & DataBinder.Eval(Container, "DataItem.num_control_mfp")& "<br>" & DataBinder.Eval(Container, "DataItem.num_control_cp")%>'>
                                    </asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <p class="SubTitleEditbox">
                                        СК Реестра:</p>
                                    <asp:TextBox ID="txtedtReestr" runat="server" Width="100%" BorderWidth="1px" Text='<%# DataBinder.Eval(Container, "DataItem.num_control_reestr") %>'
                                        BorderStyle="Solid">
                                    </asp:TextBox><br>
                                    <p class="SubTitleEditbox">
                                        СК ПЗУ:</p>
                                    <asp:TextBox ID="txtedtPZU" runat="server" Width="100%" BorderWidth="1px" Text='<%# DataBinder.Eval(Container, "DataItem.num_control_pzu") %>'
                                        BorderStyle="Solid">
                                    </asp:TextBox><br>
                                    <p class="SubTitleEditbox">
                                        СК МФП:</p>
                                    <asp:TextBox ID="txtedtMFP" runat="server" Width="100%" BorderWidth="1px" Text='<%# DataBinder.Eval(Container, "DataItem.num_control_mfp") %>'
                                        BorderStyle="Solid">
                                    </asp:TextBox>
                                    <asp:Panel ID="pnlMarkaCP" runat="server">
                                        <p class="SubTitleEditbox">
                                            СК ЦП:</p>
                                        <asp:TextBox ID="txtedtCP" runat="server" Width="100%" BorderWidth="1px" Text='<%# DataBinder.Eval(Container, "DataItem.num_control_cp") %>'
                                            BorderStyle="Solid">
                                        </asp:TextBox>
                                    </asp:Panel>
                                </EditItemTemplate>
                            ...
                            <asp:TemplateColumn SortExpression="num_control_cto" HeaderText="№ СК ЦТО">
                                <HeaderStyle Font-Underline="True"></HeaderStyle>
                                <ItemTemplate>
                                    <asp:Label ID="lbledtCTO" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.num_control_cto") & "<br>" & DataBinder.Eval(Container, "DataItem.num_control_cto2")%>'>
                                    </asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <p class="SubTitleEditbox">
                                        СК ЦТО:</p>
                                    <asp:TextBox ID="txtedtCTO" runat="server" Width="100%" BorderWidth="1px" Text='<%# DataBinder.Eval(Container, "DataItem.num_control_cto") %>'
                                        BorderStyle="Solid">
                                    </asp:TextBox>
                                    <asp:Panel ID="pnlMarkaCTO2" runat="server">
                                        <p class="SubTitleEditbox">
                                            СК ЦТО 2:</p>
                                        <asp:TextBox ID="txtedtCTO2" runat="server" Width="100%" BorderWidth="1px" Text='<%# DataBinder.Eval(Container, "DataItem.num_control_cto2") %>'
                                            BorderStyle="Solid">
                                        </asp:TextBox>
                                    </asp:Panel>
                                </EditItemTemplate>
                            ...
                            <asp:TemplateColumn SortExpression="price" HeaderText="Цена">
                                <HeaderStyle Font-Underline="True"></HeaderStyle>
                                <ItemTemplate>
                                    <asp:Label ID="lbledtPrice" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.price")%>'>
                                    </asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <p class="SubTitleEditbox">
                                        Цена:</p>
                                    <asp:TextBox ID="txtedtPrice" runat="server" Width="100%" BorderWidth="1px" Text='<%# DataBinder.Eval(Container, "DataItem.price") %>'
                                        BorderStyle="Solid">
                                    </asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn SortExpression="set_place" HeaderText="Место установки">
                                ...
                                <EditItemTemplate>
                                    <p class="SubTitleEditbox">
                                        Место установки:</p>
                                    <asp:TextBox ID="txtedtPlace" runat="server" Width="100%" BorderWidth="1px" Text='<%# DataBinder.Eval(Container, "DataItem.set_place") %>'
                                        BorderStyle="Solid">
                                    </asp:TextBox>
                                    <p class="SubTitleEditbox">
                                        Район установки:</p>
                            ...
                            <asp:TemplateColumn HeaderText="Кассиры">
                                <ItemTemplate>
                                    <asp:Label ID="lbledtKassir" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.kassir1") & "<br>" & DataBinder.Eval(Container, "DataItem.kassir2")%>'>
                                    </asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <p class="SubTitleEditbox">
                                        Кассир 1:</p>
                                    <asp:TextBox ID="txtedtKassir1" runat="server" Width="100%" BorderWidth="1px" Text='<%# DataBinder.Eval(Container, "DataItem.kassir1") %>'
                                        BorderStyle="Solid">
                                    </asp:TextBox><br>
                                    <p class="SubTitleEditbox">
                                        Кассир 2:</p>
                                    <asp:TextBox ID="txtedtKassir2" runat="server" Width="100%" BorderWidth="1px" Text='<%# DataBinder.Eval(Container, "DataItem.kassir2") %>'
                                        BorderStyle="Solid">
                                    </asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="Доп.инф.">
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:TextBox ID="txtedtInfo" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.good_info") %>'
            ...
            <tr>
                <td colspan="2" style="font-size:9px">
                    ...
                    <asp:TextBox ID="txt_numgoodto" runat="server" BorderWidth="1px" Height="18px" MaxLength="12"
                                    Width="100px"></asp:TextBox>&nbsp;(поиск по серийному номеру)
                </td>
            </tr>
            <tr>
                <td colspan="2">
                            ...
                            <asp:TemplateColumn SortExpression="num_cashregister" HeaderText="№">
                                ...
                                <ItemTemplate>
                                    <asp:HyperLink ID="lbledtNum" runat="server"
                                        Text='<%# DataBinder.Eval(Container, "DataItem.good_num") %>'>
                                    </asp:HyperLink>
                                    <p style="margin-top: 5px; margin-bottom: 0px" align="center">
                                        <asp:HyperLink ID="imgAlert" runat="server" CssClass="CutImageLink" ImageUrl="Images/sign.gif"></asp:HyperLink>
                                        <asp:HyperLink ID="imgSupport" runat="server" CssClass="CutImageLink" ImageUrl="Images/support.gif"
                                ...
                                <EditItemTemplate>
                                    <p class="SubTitleEditbox">
                                        Заводской номер:</p>
                                    <asp:TextBox ID="txtedtNum" runat="server" BorderWidth="1px" Width="100%" Text='<%# DataBinder.Eval(Container, "DataItem.good_num") %>'
                                        BorderStyle="Solid">
                                    </asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateColumn>
