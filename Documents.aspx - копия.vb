                ...
                If num_doc(k) = 1 Then
                    ...
                    Try
                        ...
                        If (Not fl.Exists()) Or isRefresh Then
                            ...
                            doc.Bookmarks("Customer").Range.Text = customer_name & ", " & ds.Tables("customer").Rows(0)("customer_address") & ", " & ds.Tables("customer").Rows(0)("bank") & ", УНН:" & customer_unn & ", " & text_phones
                ...
                Try
                    ...
                    For i = 0 To ds.Tables("details").Rows.Count - 1
                        ...
                        If ds.Tables("details").Rows(i)("is_detail") = True Then
                            ...
                            r1.Cells(7).Range.Text = String.Format("{0:0.00}", (Quantity * Math.Round(ds.Tables("details").Rows(i)("price") * 1.2 / 1) * 1))
...
ExitFunction:
        ...
        Private Function ProcessDefectAct(ByVal num_doc() As Integer, ByVal customer As Integer, ByVal cash As Integer, ByVal history As Integer) As Boolean
            ...
            Try
                ...
                doc.Save()
            Catch
                WriteError("Акт приемки и выдачи из ремонта2222<br>" & Err.Description)
                ProcessDefectAct = False
                GoTo ExitFunction
            End Try
ExitFunction:
