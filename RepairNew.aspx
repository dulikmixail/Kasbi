                                        ...
                                        <asp:DataGrid ID="grdDetails" runat="server" BorderWidth="1px" Width="100%" CellPadding="1"
                                            ...
                                            <Columns>
                                                <asp:TemplateColumn HeaderText="Name">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="cbxIsDetail" runat="server" Visible="False" Checked='<%# IIf(DataBinder.Eval(Container.DataItem,"is_detail"), "True", "False")%>'>
                                                        </asp:CheckBox>
                                                    ...
                                                    <FooterTemplate>
                                                        ...
                                                        <asp:CheckBox ID="cbxWorkNotCall" runat="server" ForeColor="Red" AutoPostBack="True"
                                                            Text="Не включать стоимость работ " OnCheckedChanged="RecalcCost"></asp:CheckBox><br>
                                                        <asp:CheckBox ID="cbxGarantia" runat="server" ForeColor="Red" AutoPostBack="True"
                                                            Text="Гарантийный ремонт" OnCheckedChanged="RecalcCost"></asp:CheckBox>
                                                    </FooterTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="Количество">
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:TextBox ID="txtAddQuantity" runat="server" Width="100%" Text='<%# DataBinder.Eval(Container, "DataItem.quantity") %>'
                                                ...
                                                <asp:TemplateColumn HeaderText="Стоимость услуги">
                                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCostService" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"cost_service")%>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                ...
                                                <asp:TemplateColumn HeaderText="Общая стоимость">
                                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblTotalSum" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"total_sum")%>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                ...
                                                <asp:TemplateColumn HeaderText="Норма/час">
                                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblNormaHour" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"norma_hour")%>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                ...
                                                <asp:TemplateColumn>
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:LinkButton ID="btnAddDetail" runat="server" Font-Size="8pt" CommandName="AddDetail"
                                                            Height="22">Добавить</asp:LinkButton><hr>
                                                    </FooterTemplate>
                                                </asp:TemplateColumn>
                                            </Columns>
                                ...
                                <tr valign="top">
                                    <td colspan="4">
                                        <asp:TextBox ID="txtNewDetails" runat="server" ToolTip="Перечислите детали, затраченные при ремонте"
                                            Height="80px" BorderWidth="1px" BackColor="#F6F8FC" Width="100%" TextMode="MultiLine"></asp:TextBox></td>
                                    <td colspan="5">
