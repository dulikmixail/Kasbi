...
#End Region
        ...
        Dim textSmsTemplate As String = "Просим оплатить ваш долг сумма={0}"
        ...
        Private Sub grdTO_SortCommand(ByVal source As System.Object,
            ...
            bind(Session("filter"))
            RecoverСheckboxes(checkedGoodIds)

        End Sub

        Private Sub RecoverСheckboxes(checkedGoodIds As ListDictionary)
        ...
        Private Sub grdTO_ItemDataBound(ByVal sender As System.Object,
            ...
            If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
                ...
                If _
                    ...
                    CType(e.Item.FindControl("lblGoodOwner"), HyperLink).Text = s & "; Договор №" & dogovor
        ...
        Protected Sub lnkSendSms_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If selectedCustomerIds.Count = 0
                    msgCashregister.Text = "Выберите кому хотите отправить СМС."
                    Exit Sub
                End If
            ...
            Catch ex As Exception
                msgCashregister.Text = "Произошла одна или много ошибок при отправке СМС. " & ex.Message
            End Try
        End Sub
