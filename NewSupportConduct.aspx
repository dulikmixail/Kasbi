...
<body onscroll="javascript:document.all['scrollPos'].value=document.body.scrollTop;"
    ...
    <form id="frmNewRequest" method="post" runat="server">
        ...
        <table class="PageTitle" cellspacing="1" cellpadding="2" width="100%" border="0">
            <tr>
                <td class="HeaderTitle" width="100%">0
                    &nbsp;Карточка ККМ -&gt; Постановка&nbsp;на&nbsp;ТО&nbsp;/&nbsp;Снятие&nbsp;с&nbsp;ТО&nbsp;/&nbsp;Приостановка&nbsp;ТО</td>
            </tr>
        </table>
        <table cellspacing="1" cellpadding="2" width="100%">
            ...
            <tr class="Unit">
                <td class="Unit" colspan="2">
                    <asp:Label ID="SectionTOName" runat="server">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Провеение 
									технического обслуживания</asp:Label></td>
            </tr>
                        ...
                        <tr>
                            ...
                            <td class="SectionRow" colspan="2">
                                <asp:TextBox ID="txtGoodNumCashregister" runat="server" ToolTip="Введите заводской номер"
                                    BackColor="#F6F8FC" Width="150px" MaxLength="8" BorderWidth="1px" Enabled="False"></asp:TextBox></td>
                        </tr>
                        <tr class="TitleTextbox">
                            <td class="SectionRowLabel" align="left">
                                Исполнитель:</td>
                            ...
                            <td colspan="3">
                                <table id="pnlConduct" width="100%" runat="server">
                                    <tr class="SubTitleTextbox">
                                        <td>
                                            &nbsp;</td>
                                        <td align="left">
                                            <asp:Label ID="Label9" runat="server">до проведения</asp:Label></td>
                                        <td align="left">
                                            <asp:Label ID="Label10" runat="server">после проведения</asp:Label></td>
                                    </tr>
                                    <tr class="TitleTextbox">
                                        <td class="SectionRowLabel" align="left">
                                            СК ЦТО:</td>
                                        <td class="SectionRow" align="left">
                                            <asp:TextBox ID="txtMarka_Cond_CTO_in" runat="server" BackColor="#F6F8FC" Width="160px"
                                                MaxLength="11" BorderWidth="1px"></asp:TextBox></td>
                                        <td class="SectionRow" align="left">
                                    ...
                                    <tr class="TitleTextbox">
                                        ...
                                        <td class="SectionRow" style="width: 189px" align="left">
                                            ...
                                            <asp:DropDownList ID="lstMonthDelayIn" runat="server" BackColor="#F6F8FC" BorderWidth="1px">
                                                ...
                                                <asp:ListItem Value="11">Ноябрь</asp:ListItem>
                                                <asp:ListItem Value="12">Декабрь</asp:ListItem>
                                            </asp:DropDownList><asp:DropDownList ID="lstYearDelayIn" runat="server" BackColor="#F6F8FC"
                                                BorderWidth="1px">
                                                <asp:ListItem Value="2003">2003</asp:ListItem>
                                                <asp:ListItem Value="2004">2004</asp:ListItem>
                                                <asp:ListItem Value="2005">2005</asp:ListItem>
                                ...
                                <table id="pnlDismissal" width="100%" runat="server">
                                    <tr class="SubTitleTextbox">
                                        ...
                                        <td align="left">
                                            <asp:Label ID="Label14" runat="server">до снятия</asp:Label></td>
                                        <td align="left">
                                            <asp:Label ID="Label15" runat="server">после снятия</asp:Label></td>
                                    </tr>
                                    <tr class="TitleTextbox">
                                        <td class="SectionRowLabel" align="left">
                                            СК ЦТО:</td>
                                    ...
                                    <tr class="SubTitleTextbox">
                                        ...
                                        <td align="left" colspan="2">
                                            <asp:CompareValidator ID="Comparevalidator1" runat="server" CssClass="ErrorMessage"
                                                ...
                                                Type="Date" Operator="DataTypeCheck">Пожалуйста, введите корректныое значение даты снятия с ТО</asp:CompareValidator></td>
                                    </tr>
                                </table>
                                <table id="pnlSupport" width="100%" runat="server">
                                    ...
                                    <tr class="SubTitleTextbox">
                                        ...
                                        <td align="left">
                                            <asp:Label ID="Label13" runat="server">до постановки</asp:Label></td>
                                        <td align="left">
                                            <asp:Label ID="Label16" runat="server">после постановки</asp:Label></td>
                                    </tr>
                                    <tr class="TitleTextbox">
                                        <td class="SectionRowLabel" align="left">
                                            СК ЦТО:</td>
                                    ...
                                    <tr class="TitleTextbox">
                                        ...
                                        <td class="SectionRow" align="left" colspan="2">
                                            ...
                                            <asp:CompareValidator ID="typeValidator" runat="server" CssClass="ErrorMessage" ControlToValidate="tbxSupportDate"
                                                EnableClientScript="False" Display="Dynamic" Type="Date" Operator="DataTypeCheck">Пожалуйста, введите корректные значение даты постановки</asp:CompareValidator></td>
                                    </tr>
                                    <tr class="TitleTextbox">
                                        <td class="SectionRowLabel" align="left">
                                            <asp:Label ID="lblSaleInfo" runat="server" CssClass="text02">Тип документа :</asp:Label></td>
            ...
            <asp:Panel ID="pnlSupportConductHistory" runat="server">
                <tr class="Unit">
                    <td class="Unit" colspan="4">
                        ...
                        </asp:ImageButton>&nbsp;История&nbsp;проведения&nbsp;технического&nbsp;обслуживания&nbsp;кассового&nbsp;аппарата</td>
                </tr>
                    ...
                    <tr>
                        <td colspan="3">
                            <asp:Label ID="msgSupportConductHistory" runat="server" EnableViewState="False" Font-Bold="True"
                                ForeColor="Red" Font-Size="8pt"></asp:Label></td>
                    </tr>
                    <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtedtMarkaCTOIn" runat="server" ToolTip="Введите марку ЦТО до обслуживания"
                                                            BorderWidth="1px" BackColor="#F6F8FC" Width="90px" MaxLength="11"></asp:TextBox></td>
                                                    <td>
